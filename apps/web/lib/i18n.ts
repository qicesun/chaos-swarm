...
const messages = {
  en: {
    ...
    "composer.strictVisualBody":
      "Strict visual mode disables DOM locator fallback after visual actions fail. Hybrid mode keeps coordinate-first execution but allows DOM recovery when the page gets brittle.",
  ...
  zh: {
    ...
    "composer.strictVisualBody": "严格视觉模式会在视觉动作失败后禁止 DOM locator 兜底。混合模式依然以坐标和键盘为主，但页面变脆时允许 DOM 恢复。",
    ...
    "report.executionPurityTitle": "这次运行有多“像真人”",
